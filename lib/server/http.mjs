...
export function route(handler, {
  ...
  return async function wrapped(req, res) {
    ...
    try {
      ...
      // it here means no route has to remember to list it, and link checkers and
      // proxies stop getting a 405 for a perfectly ordinary request.
      const allowed = methods.includes("GET") && !methods.includes("HEAD")
        ? [...methods, "HEAD"]
        : methods;
