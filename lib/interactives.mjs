...
//
// The list is what `assets/vendor/` actually holds, not what §3.6 offered as
// examples. `d3` was named there and is not vendored, so accepting it would
// publish a figure that resolves, builds, and then fails in the reader's
// browser because nothing ever defines it. A dependency is a promise the engine
// has to keep.
export const VENDORED_DEPENDENCIES = ["distill"];
